...
$sql ="SELECT * FROM userinfo WHERE email='".$_SESSION['us']."'";
...
echo"<form action='fpass.php' class='formoid-default' style='background-color:#ADD8E6;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;width:480px' title='My Formoid form' method='post'>";
echo"<div class='element-text' >";
echo"<h2 class='title'>Update Account</h2></div>";
echo"<div class='element-input' >";
echo"<label class='title'>User FullName</label>";
echo"<input type='text' name='fn' readonly value='".$row['user_name']."'></div>";
echo"<div class='element-input' >";
...
echo"<div class='element-input' >";
echo"<label class='title'>Gender</label>";
echo"<input type='text' name='con' readonly value='".$row['gender']."'></div>";
echo"<div class='element-email' >";
echo"<label class='title'>Date Of Birth</label>";
echo"<input type='text' name='dob' readonly value='".$row['dob']."'></div>";
echo"<label class='title'>Contact</label>";
echo"<input type='text' name='fid'  value='".$row['mobile']."'required></div>";
