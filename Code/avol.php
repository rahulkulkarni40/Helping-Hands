...
echo'</script>';
echo"<th><center>Name.</center></th><th>Email</th><th>Mobile</th><th>delete</th></p>";
	...
	$sub=$row['mobile'];
		...
		echo"<tr><td>".$name."</td><td>".$email."</td><td>".$sub."</td><td><a href='del2.php?idd=".$email."' style='color:red;'>Delete</a></td> ";
